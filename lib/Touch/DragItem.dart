...
class DragItemPage extends StatefulWidget {
  _DragItemPageState createState() => _DragItemPageState();
}

class _DragItemPageState extends State<DragItemPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(children: <Widget>[
        ...
        Center(child: DragTarget(onAccept: (Color color){ _draggableColor = color;
        },
...
class _DraggableWidgetState extends State<DraggableWidget> {
  ...
  @override
  Widget build(BuildContext context) {
    return Positioned(left: offset.dx,top: offset.dy,
    child: Draggable(
