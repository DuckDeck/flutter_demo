...
class _CreatePlayListWidgetState extends State<CreatePlayListWidget> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(ScreenUtil().setWidth(29)))),
      content: Theme(
        ...
        child: Column(
          ...
          children: <Widget>[
            TextField(controller: _editingController,decoration: InputDecoration(hintText: '请输入歌单标题',hintStyle: common14GrayTextStyle),style: common14TextStyle,maxLength: 40,),
            ...
            child: Row(children: <Widget>[
              SizedBox(width: ScreenUtil().setWidth(40),height: ScreenUtil().setWidth(40),
              child: Checkbox(
                activeColor: Colors.red,value: isPrivatePlayList,onChanged: (v){
                  setState(() {
                    isPrivatePlayList = v;
                  });
                },
